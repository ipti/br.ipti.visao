        ...
        <div className="print-container" >
            ...
            <div ref={contentRef}>
                <Padding padding="14px">
                    ...
                    <div>
                        ...
                        <TableWrapper>
                            <Table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <TableData style={{ width: "120px", whiteSpace: "nowrap" }}>Olho direito</TableData>
                                    ...
                                    <tr>
                                        <TableData style={{ width: "120px", whiteSpace: "nowrap" }}>Olho esquerdo</TableData>
                        ...
                        <TableWrapper>
                            <Table>
                                <thead>
                                    <tr>
                                        <TableHeader style={{ textAlign: "center" }}>Olho direito</TableHeader>
                                        <TableHeader style={{ textAlign: "center" }}>Olho esquerdo</TableHeader>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
                            <TableWrapper style={{ flex: '1', marginLeft: '10px' }}>
                                ...
                                <Table>
                                    <thead>
                                        <tr>
                                            <TableHeader style={{ width: "10px", whiteSpace: "nowrap" }}></TableHeader>
                                            <TableHeader style={{ textAlign: "left" }}>Resultados</TableHeader>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <TableData style={{ width: "160px", whiteSpace: "nowrap" }}>Motilidade Ocular</TableData>
                                            <TableData style={{ textAlign: "left" }}>{students?.object.motilidadeOcular}</TableData>
                                        </tr>
                                        <tr>
                                            <TableData style={{ width: "160px", whiteSpace: "nowrap" }}>Diagnóstico</TableData>
                                            <TableData style={{ textAlign: "left" }}>{students?.object.diagnostico}</TableData>
                                        </tr>
                                        <tr>
                                            <TableData style={{ width: "160px", whiteSpace: "nowrap" }}>Conduta</TableData>
                            ...
                            <TableWrapper style={{ flex: '1', marginLeft: '10px' }}>
                                ...
                                <Table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <TableData style={{ width: "160px", whiteSpace: "nowrap" }}>Olho direito</TableData>
                                            <TableData style={{ textAlign: "left" }}>{students?.object.fundoscopiaOd}</TableData>
                                        </tr>
                                        <tr>
                                            <TableData style={{ width: "160px", whiteSpace: "nowrap" }}>Olho esquerdo</TableData>
                        ...
                        <div className='oculos-alert' style={{
                            display: 'flex',
                            alignItems: 'center',
                            border: `3px solid`,
                            borderColor: `${students?.object.precisaOculos ? '#00cc10' : '#cc0000'}`,
                            padding: '8px',
                            borderRadius: '4px',
                            width: '250px',
                            height: '40px'
                    ...
                    <p style={{ textAlign: 'right', fontSize: '12px' }}> Consulta realizada por um profissional da saúde. Data de emissão: {formatarDataHora()}</p>
                </Padding>
            </div>
        </div>
    )
