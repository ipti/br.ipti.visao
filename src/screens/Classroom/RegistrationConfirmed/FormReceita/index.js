...
const FormReceita = ({ values, handleChange }) => {
  ...
  const [isReceitaCheckboxDisabled, setIsReceitaCheckboxDisabled] =
    useState(true);
      ...
      <Grid container spacing={2} md={12}>
        <Grid item style={{ width: "100%" }} md={4}>
          ...
          <Column>
            <TextField
              ...
              name="receitaEsfericoOlhoDireito"
              value={values.receitaEsfericoOlhoDireito}
        ...
        <Grid item style={{ width: "100%" }} md={4}>
          ...
          <Column>
            <TextField
              className={classes.inputStudent}
              name="receitaCilindricoOlhoDireito"
              value={values.receitaCilindricoOlhoDireito}
              onChange={handleChange}
              variant="outlined"
              disabled={!isAdmin && !isMedico}
            />
        ...
        <Grid item style={{ width: "100%" }} md={4}>
          ...
          <Column>
            <TextField
              className={classes.inputStudent}
              name="receitaEixoOlhoDireito"
              value={values.receitaEixoOlhoDireito}
              onChange={handleChange}
              variant="outlined"
              disabled={!isAdmin && !isMedico}
            />
      ...
      <Grid container spacing={2} md={12}>
        <Grid item style={{ width: "100%" }} md={4}>
          ...
          <Column>
            <TextField
              className={classes.inputStudent}
              name="receitaDpOlhoDireito"
              value={values.receitaDpOlhoDireito}
              onChange={handleChange}
              variant="outlined"
              disabled={!isAdmin && !isMedico}
            />
      ...
      <Grid container spacing={2} md={12}>
        <Grid item style={{ width: "100%" }} md={4}>
          ...
          <Column>
            <TextField
              className={classes.inputStudent}
              name="receitaEsfericoOlhoEsquerdo"
              value={values.receitaEsfericoOlhoEsquerdo}
              onChange={handleChange}
              variant="outlined"
              disabled={!isAdmin && !isMedico}
            />
        ...
        <Grid item style={{ width: "100%" }} md={4}>
          ...
          <Column>
            <TextField
              className={classes.inputStudent}
              name="receitaCilindricoOlhoEsquerdo"
              value={values.receitaCilindricoOlhoEsquerdo}
              onChange={handleChange}
              variant="outlined"
              disabled={!isAdmin && !isMedico}
            />
        ...
        <Grid item style={{ width: "100%" }} md={4}>
          ...
          <Column>
            <TextField
              className={classes.inputStudent}
              name="receitaEixoOlhoEsquerdo"
              value={values.receitaEixoOlhoEsquerdo}
              onChange={handleChange}
              variant="outlined"
              disabled={!isAdmin && !isMedico}
            />
      ...
      <Grid container spacing={2} md={12}>
        <Grid item style={{ width: "100%" }} md={4}>
          ...
          <Column>
            <TextField
              className={classes.inputStudent}
              name="receitaDpOlhoEsquerdo"
              value={values.receitaDpOlhoEsquerdo}
              onChange={handleChange}
              variant="outlined"
              disabled={!isAdmin && !isMedico}
            />
